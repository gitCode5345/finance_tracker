...
class TransactionsEvent with _$TransactionsEvent {
  ...
  const factory TransactionsEvent.getTransactions({required String period, TransactionsGetCount? count}) = GetTransactionsEvent;
  const factory TransactionsEvent.getTransactionsSilent({required String period, TransactionsGetCount? count}) = GetTransactionsSilentEvent;
  ...
  const factory TransactionsEvent.getTransactionsByTypeSilent({required String type, String? period, TransactionsGetCount? count}) = GetTransactionsByTypeSilentEvent;
  const factory TransactionsEvent.loadMoreTransactions() = LoadMoreTransactionsEvent;
